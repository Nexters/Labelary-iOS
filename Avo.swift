// Generated by Avo VERSION 104.95.0. You should never have to make changes to this file.
...
public protocol AvoProtocol {
    init (env: AvoEnv, rudderStackDestination: AvoCustomDestination,
...
public class Avo: AvoProtocol {
    ...
    public convenience init (env: AvoEnv,
        ...
        self.init(env: env,  rudderStackDestination: rudderStackDestination, strict: strict,noop: noop)
        if !__NOOP__ {
    ...
    public func homeView(labelList: [LabelList]?) {
        ...
        if __ENV__ != .prod || __MOBILE_DEBUGGER_ENABLED__() {
            ...
            // debug console in Avo
            if !__NOOP__ {
                AvoInvoke.invoke("R4h1Xtm1Oh", "c796f800639f29c48024fda0cc0ceb0d0698d4670f774049c5b1fbf5ac79d4d1", messages)
            }
            if __ENV__ != .prod && __DEBUGGER__ != nil || __ENV__ == .prod && __MOBILE_DEBUGGER_ENABLED__() {
                // Avo mobile debugger
                let event_props: Array<Dictionary<String, String>> = [
        ...
        if !__NOOP__ {
            if self.__INSPECTOR__ != nil {
                ...
                if self.__INSPECTOR__?.responds(to: trackSchemaFromEventSelector) == true {
                    ...
                    inspectorEventProperties["avoFunctionEventHash"] = "c796f800639f29c48024fda0cc0ceb0d0698d4670f774049c5b1fbf5ac79d4d1"
    ...
    public func screenshotLabeling(labelList: [LabelList]) {
        ...
        if __ENV__ != .prod || __MOBILE_DEBUGGER_ENABLED__() {
            ...
            // debug console in Avo
            if !__NOOP__ {
                AvoInvoke.invoke("9_Dh-CMg9H", "f86dcc5496529ef614a58418d851c85247e17cd9159adc7b83137b79cd741fe9", messages)
            }
            if __ENV__ != .prod && __DEBUGGER__ != nil || __ENV__ == .prod && __MOBILE_DEBUGGER_ENABLED__() {
                // Avo mobile debugger
                let event_props: Array<Dictionary<String, String>> = [
        ...
        if !__NOOP__ {
            if self.__INSPECTOR__ != nil {
                ...
                if self.__INSPECTOR__?.responds(to: trackSchemaFromEventSelector) == true {
                    ...
                    inspectorEventProperties["avoFunctionEventHash"] = "f86dcc5496529ef614a58418d851c85247e17cd9159adc7b83137b79cd741fe9"
